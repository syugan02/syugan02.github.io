...
![](./img/고블린.png)|고블린|근거리|없음
![](./img/활%20고블린.png)|활 고블린|원거리|플레이어 위치에 화살을 쏴 공격
![](./img/오크.png)|오크|원거리|플레이어 위치에 마법진을 보여준 후 지속 공격
![](./img/골렘.png)|골렘|근/원거리|네임드 적, 근접 공격과 멀리 떨어지면 원거리 공격을 하며 원거리 공격에 맞으면 스턴 상태가 됨
![](./img/스켈레톤.png)|스켈레톤|근거리|없음
![](./img/드래곤.png)|드래곤|근/원거리|보스, 근접 공격과 멀리 떨어지면 원거리 공격을 하며, 굉장히 멀리 떨어지면 플레이어를 향해 날아옴
