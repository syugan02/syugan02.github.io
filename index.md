...
<img src="./img/드래곤.png" width = 100 heigth = 100>|드래곤|근/원거리|보스, 근접 공격과 멀리 떨어지면 원거리 공격을 하며, 굉장히 멀리 떨어지면 플레이어를 향해 날아옴
...
|그림|이름|설명|
|:---:|:---:|:---:|
![](./img/체력%20회복%20포션.png)|체력 회복 포션|사용하면 체력을 일정량 회복시켜주는 포션. 1을 눌러 사용이 가능하다.
![](./img/SP%20회복%20포션.png)|SP 회복 포션|사용하면 필살기 게이지를 일정량 회복시켜주는 포션. 2를 눌러 사용이 가능하다.
![](./img/폭탄.png)|폭탄|사용하면 지정 범위로 날아가 대미지와 스턴을 주는 아이템. F키를 눌러 마우스를 움직이면 위치를 설정하고, F키를 떼면 해당 위치로 날아간다.
