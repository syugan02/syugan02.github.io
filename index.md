...
|그림|이름|근/원거리|특이사항|
|:---:|:---:|:---:|:---:|
<img src="./img/슬라임.png" width = 50 heigth = 50>|슬라임|근거리|없음
<img src="./img/고블린.png" width = 50 heigth = 50>|고블린|근거리|없음
<img src="./img/활 고블린.png" width = 50 heigth = 50>|활 고블린|원거리|플레이어 위치에 화살을 쏴 공격
<img src="./img/오크.png" width = 50 heigth = 50>|오크|원거리|플레이어 위치에 마법진을 보여준 후 지속 공격
<img src="./img/골렘.png" width = 50 heigth = 50>|골렘|근/원거리|네임드 적, 근접 공격과 멀리 떨어지면 원거리 공격을 하며 원거리 공격에 맞으면 스턴 상태가 됨
<img src="./img/스켈레톤.png" width = 50 heigth = 50>|스켈레톤|근거리|없음
<img src="./img/드래곤.png" width = 50 heigth = 50>|드래곤|근/원거리|보스, 근접 공격과 멀리 떨어지면 원거리 공격을 하며, 굉장히 멀리 떨어지면 플레이어를 향해 날아옴
